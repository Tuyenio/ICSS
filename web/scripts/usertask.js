            ...
            <form class="modal-content" id="formEditStepStatus">
              ...
              <div class="modal-body">
                ...
                <div class="mb-2">
                  ...
                  <input type="file" class="form-control" name="stepFileTaiLieu" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx">
                  <small class="text-muted">File đính kèm (tối đa 50MB)</small>
                  ${step.fileTaiLieu ? `<div class="mt-2"><small>File hiện tại: ${step.fileTaiLieu}</small></div>` : ''}
                </div>
              </div>
