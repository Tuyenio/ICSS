...
<html lang="vi">
    ...
    <body>
        ...
        <div id="chartDataHolder" style="display:none"
             ...
             data-kt-statuses="<%= String.join("|", (List<String>) tienDoKyThuat.getOrDefault("projectStatuses", Collections.emptyList())) %>"
             data-kd-project-names="<%= anNinhProjectNamesAttr %>"
             data-kd-project-ids="<%= anNinhProjectIdsAttr.toString() %>"
             data-kd-statuses="<%= String.join("|", (List<String>) tienDoKinhDoanh.getOrDefault("projectStatuses", Collections.emptyList())) %>"
