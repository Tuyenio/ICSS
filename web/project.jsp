...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            /* Status inline edit */
            .editable-status, .editable-priority {
                cursor: pointer;
            }

            .editable-status:hover, .editable-priority:hover {
                opacity: 0.8;
            }
            ...
            <div class="flex-grow-1">
                ...
                <div class="main-content">
                    ...
                    <div class="projects-grid" id="cardView">
                        ...
                        <div class="project-card" data-id="<%= p.get("id") %>" onclick="window.location.href='dsCongviecDuan?projectId=<%= p.get("id") %>';" style="cursor:pointer;">
                            ...
                            <div class="editable-status mb-2" data-id="<%= p.get("id") %>">
                    ...
                    <div class="table-view" id="tableView" style="display: none;">
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                %>
                                <tr onclick="window.location.href='dsCongviecDuan?projectId=<%= p.get("id") %>';" style="cursor:pointer;">
                                    ...
                                    <td class="editable-priority" data-id="<%= p.get("id") %>">
