...
<nav class="sidebar p-0">
    ...
    <ul class="sidebar-nav mt-3">
        ...
        <li>
            <a href="user_salary.jsp" class="active"><i class="fa-solid fa-money-bill"></i><span>Lương & KPI</span></a>
        </li>
...
<div class="main-content">
    <div class="main-box mb-3">
        <h3 class="mb-0"><i class="fa-solid fa-money-bill me-2"></i>Lương & KPI</h3>
