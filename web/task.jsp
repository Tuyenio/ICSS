                                    ...
                                    <div class="kanban-task archived-task"
                                        ...
                                        <div class="task-content"
                                            ...
                                            <div class="task-meta">Người giao: <b><%= task.get("nguoi_giao_id") %></b><br>
                                                ...
                                                Người theo dõi: <b><%= task.get("nguoi_theo_doi_ten") != null ? task.get("nguoi_theo_doi_ten") : "Chưa có" %></b></div>
                                    ...
                                    <div class="kanban-task deleted-task"
                                        ...
                                        <div class="task-content"
                                            ...
                                            <div class="task-meta">
                                                ...
                                                Người nhận: <b><%= task.get("nguoi_nhan_ten") %></b><br>
                                                Người theo dõi: <b><%= task.get("nguoi_theo_doi_ten") != null ? task.get("nguoi_theo_doi_ten") : "Chưa có" %></b>
                                            </div>
