...
<head>
    ...
    <title>Xin nghỉ phép - ICSS</title>
    ...
    <div class="main-content">
        ...
        <div class="page-header animate-fadeInUp">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div>
                    <h2><i class="fa-solid fa-calendar-xmark me-3"></i>Xin nghỉ phép</h2>
                    <p><i class="fa-regular fa-clock me-2"></i>Quản lý đơn xin nghỉ phép của bạn</p>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="stat-card used animate-fadeInUp delay-2">
                    ...
                    <div class="stat-label">Số phép <%= namHienTai %> đã dùng</div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                ...
                                <select class="form-select" name="loaiPhep" required>
                                    ...
                                    <option value="Nghỉ cưới/tang">💍 Nghỉ cưới/tang</option>
